  ...
  actions: {
    ...
    async getLastMessages(chatGUID) {
      try {
        ...
        this.currentChatMessages = messagesInfo.messages.map(msg => this.processMessage(msg));
    ...
    async getHistoricalMessages(chatGUID, lastMessageGUID) {
      try {
        ...
        let messagesInfo = response.data;
        messagesInfo.messages = messagesInfo.messages.map(msg => this.processMessage(msg));
        return messagesInfo;
      } catch (error) {
