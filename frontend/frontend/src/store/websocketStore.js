    ...
    handleNewMessage(receivedMessage) { 
      ...
      if (receivedMessage.type === "new" || receivedMessage.type === "new_file") {
        ...
        if (foundChatIndex !== -1) {
          ...
          if (receivedMessage.chat_guid === chatStore.currentChatGUID) {
            console.log("📌 Before adding message, current messages:", messageStore.currentChatMessages);
            
            messageStore.currentChatMessages.push(receivedMessage);
    
            console.log("✅ After adding message, current messages:", messageStore.currentChatMessages);
          }
